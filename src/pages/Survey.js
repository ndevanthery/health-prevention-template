        ...
        <>
            ...
            <div className="survey">
                ...
                <Link to="/results" state={{infos: survey}}>
                    <button className="buttonSurvey" onClick={onClickButton}>Calculate results</button>
                </Link>
...
function Answer({id, typeAnswer, inputChange, value}) {
    switch (typeAnswer) {
        case type.numeric:
            return (<input className="selectionSurvey" onChange={inputChange} id={id} name={id} type="number" value={value}></input>);
            break;
        case type.boolean:
            return (
                <select className="selectionSurvey" name={id} id={id} onChange={inputChange} value={value}>

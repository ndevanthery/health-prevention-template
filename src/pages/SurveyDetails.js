    ...
    return (
        <div className="history">
            <table className="table">
                ...
                <tr>
                    <td colSpan="2"><h2 className="titleSurveyDetails">Questions about your family</h2></td>
                </tr>
                <tr>
                    <td><br></br></td>
                </tr>
                ...
                <tr>
                    <td colSpan="2"><h2 className="titleSurveyDetails">Questions about your habits</h2></td>
                </tr>
                <tr>
                    <td><br></br></td>
                </tr>
